...
def mock_node_for_test_start(mocker):
    ...
    mocker.patch.object(EconomicHandler, "blacklist_rpch_nodes", return_value=None)
    mocker.patch.object(EconomicHandler, "blacklist_ct_nodes", return_value=None)
...
async def test_start(mock_node_for_test_start: EconomicHandler):
    ...
    assert node.blacklist_rpch_nodes.called
    assert node.blacklist_ct_nodes.called
