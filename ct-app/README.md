...
`DISTRIBUTION_MAX_APR_PERCENTAGE` | `15.0` | APR max value. Any APR above this value will be restricted
...
- `FLAG_CORE_PREPARE_DISTRIBUTION` 

The following flags encables `Node` features:
