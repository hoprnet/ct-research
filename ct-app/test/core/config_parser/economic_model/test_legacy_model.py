...
from core.config_parser.economic_model import LegacyParams
...
def test_transformed_stake_returns_zero_below_lowerbound(model: LegacyParams):
    assert model.transformed_stake(model.coefficients.lowerbound / 2) == ZERO_BALANCE
