...
app = Celery(name=Utils.envvar("PROJECT_NAME"), broker=Utils.envvar("CELERY_BROKER_URL"))
app.autodiscover_tasks(force=True)


async def channel_balance(
    api: HoprdAPI, src_peer_id: str, dest_peer_id: str
) -> float:
    """
...
async def async_send_1_hop_message(
    ...
    max_attempts = Utils.envvar("MAXATTEMPTS", int)
